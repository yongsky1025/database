...
-- NULL을 ("SCOTT"."TABLE_NOTNULL"."LOGIN_PWD") 을 업데이트할 수 없습니다
...
CREATE TABLE EMP_FK(
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) REFERENCES DEPT_FK(DEPTNO) -- 참조할 테이블명(칼럼명)
);
...
INSERT INTO DEPT_FK(10, 'DATABASE', 'SEOUL');
INSERT INTO EMP_FK(EMPNO,ENAME,JOB,MGR,HIREDATE,SAL,COMM,DEPTNO)
...
INSERT INTO TABLE_CHECK VALUES('test01', 'test', 8, '010-1234-7869');
...
INSERT INTO TABLE_DEFAULT VALUES('test01', NULL, '010-1234-7869');
